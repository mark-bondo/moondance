    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Invoice_supplier_fk', to='operations.supplier', verbose_name='Invoicing Supplier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_last_updated_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Last Updated By')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('supplier', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.supplier', verbose_name='Invoicing Supplier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_last_updated_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Last Updated By')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('invoice', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.invoice')),
                ('manufacturer', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.supplier', verbose_name='Manufacturer')),
                ('sku', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.materials_management_proxy', verbose_name='MoonDance SKU')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Supplier_Product_product_fk', to='operations.materials_management_proxy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Recipe_sku_fk', to='operations.materials_management_proxy')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='Invoice_Manufacturer_fk', to='operations.supplier', verbose_name='Manufacturer')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Invoice_Line_sku_fk', to='operations.materials_management_proxy', verbose_name='MoonDance SKU')),
            ],
            options={
