    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Finished Goods', 'Finished Goods'), ('WIP', 'WIP'), ('WIP - Labor', 'WIP - Labor'), ('Raw Materials', 'Raw Materials'), ('Labor', 'Labor')], max_length=200)),
                ...
                ('sales_channel_type', models.CharField(blank=True, choices=[('All', 'All'), ('FBA', 'FBA'), ('MoonDance', 'MoonDance')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(blank=True, db_constraint=False, limit_choices_to=models.Q(_negated=True, product_code__type__in=['Finished Goods']), null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(limit_choices_to=models.Q(_negated=True, product_code__type__in=['Finished Goods']), on_delete=django.db.models.deletion.PROTECT, related_name='Recipe_sku_fk', to='operations.product')),
