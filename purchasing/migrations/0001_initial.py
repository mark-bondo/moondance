    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_created', models.DateTimeField(blank=True, editable=False, verbose_name='Datetime Created')),
                ('_last_updated', models.DateTimeField(blank=True, editable=False, verbose_name='Datetime Updated')),
                ('unit_of_measure', models.CharField(choices=[('grams', 'grams'), ('oz', 'oz'), ('lbs', 'lbs'), ('each', 'each'), ('minutes', 'minutes')], max_length=200)),
                ...
                ('manufacturer', models.ForeignKey(blank=True, db_constraint=False, help_text='Only needs to be populated if the manufacturer is different than the invoicing supplier.', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='purchasing.supplier', verbose_name='Manufacturer')),
                ('sku', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='operations.product', verbose_name='MoonDance SKU')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_created', models.DateTimeField(blank=True, editable=False, verbose_name='Datetime Created')),
                ('_last_updated', models.DateTimeField(blank=True, editable=False, verbose_name='Datetime Updated')),
                ('location', models.CharField(choices=[('Bondo - Garage', 'Bondo - Garage'), ('Bondo - 2nd Floor', 'Bondo - 2nd Floor'), ('MoonDance - Workshop', 'MoonDance - Workshop'), ('MoonDance - Fulfillment Center', 'MoonDance - Fulfillment Center')], max_length=200, verbose_name='Current Location')),
                ('quantity_onhand', models.DecimalField(decimal_places=2, max_digits=12)),
                ('to_location', models.CharField(blank=True, choices=[('Bondo - Garage', 'Bondo - Garage'), ('Bondo - 2nd Floor', 'Bondo - 2nd Floor'), ('MoonDance - Workshop', 'MoonDance - Workshop'), ('MoonDance - Fulfillment Center', 'MoonDance - Fulfillment Center')], max_length=200, null=True, verbose_name='Transfer To Location')),
                ('transfer_quantity', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Supplier_Product_product_fk', to='operations.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(blank=True, help_text='Only needs to be populated if the manufacturer is different than the invoicing supplier.', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='Invoice_Manufacturer_fk', to='purchasing.supplier', verbose_name='Manufacturer')),
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='Invoice_Line_sku_fk', to='operations.product', verbose_name='MoonDance SKU')),
            ],
            options={
